%run ./18-streaming-incremental-aggregation
...
class AggregationTestSuite():
    ...
    def runTests(self):
        ...
        spark.conf.set("spark.sql.streaming.stateStore.providerClass", 
                       "org.apache.spark.sql.execution.streaming.state.RocksDBStateStoreProvider") #better performance when using stateful operation, quick read/write on the disk (not RAM),in that case better than InMemoryStateStore
        bzStream = Bronze()
