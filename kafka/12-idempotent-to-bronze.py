# idempotent means that operation can be repeated multiple times without changing the result
# solves problem of duplicates
# after failures, when we want again consume the same data from the past, but not all was processed properly
